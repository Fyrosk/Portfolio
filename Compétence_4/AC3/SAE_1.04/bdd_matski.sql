/*==============================================================*/
/* SCRIPT SQL SAé 1.04    Création d'une Base de données        */ 
/* Janvier 2022                                                 */
/*==============================================================*/
...
create table CLIENT (
   ...
   NOMCONTACT1          VARCHAR(50)          null,
   TELEPHONECONTACT1    VARCHAR(12)             null,
   FONCTIONCONTACT1     VARCHAR(20)          null,
   NOMCONTACT2          VARCHAR(50)          null,
   TELEPHONECONTACT2    VARCHAR(12)             null,
   FONCTIONCONTACT2     VARCHAR(20)          null,
   constraint PK_CLIENT primary key (NUMCLIENT)
);
--copy (Select * From client) To '/Users/pcoli/desktop\client.csv' With CSV 


Insert into CLIENT (CODELISTE, CODEETIQUETTE , NOMCLIENT ,ADRESSERUECLIENT, ADRESSECODEPOSTALCLIENT , ADRESSEVILLECLIENT, ADRESSEPAYSCLIENT ,
   TELEPHONECLIENT, MAILCLIENT, NOMCONTACT1, TELEPHONECONTACT1 , FONCTIONCONTACT1, NOMCONTACT2 , TELEPHONECONTACT2 , FONCTIONCONTACT2 ) values 
('E','FR','GO Sport Agen','Zac agen Sud',47000,'Agen','France','043423245476','gosportA@gmail.fr','Fallon','043423245477','Commercial','Colquit','043423245478','Responsable'),
('E','FR','GO Sport Albi','50 route de Saint Juery',81000,'Albi','France','043623245476','gosportAlbi@gmail.fr','Darigan','043623245477','Responsable','Caney','043623245478','Responsable ventes'),
('E','FR','GO Sport Nantes','Place de Bretagne',74000,'Annecy','France','044023245476','gosportNantes@gmail.fr','Mudrell','044023245477','Acheteur','Layton','044023245478','Responsable'),
('E','FR','GO Sport Aulnay','O Parinot',93600,'Aulnay sous Bois','France','044223245476','gosportAnnecy@gmail.fr','Betser','044223245477','Vendeur','Polet','044223245478','Accueil'),
('E','FR','GO Sport Paris 12','135 rue Daumesnil',75012,'Paris','France','044423245476','gosportAnnecy@gmail.fr','Weaver','044423245477','Commercial','Doge','044423245478','Responsable'),
('E','FR','GO Sport Orange','Les vignes',84100,'Orange','France','044523245476','gosportAnnecy@gmail.fr','Noades','044523245477','Acheteur','Stegers','044523245478','Commercial'),
('E','FR','GO Sport Perpignan','1050 Avenue d''Espagne',66000,'Perpignan','France','044623245476','gosportAnnecy@gmail.fr','Alessandrucci','044623245477','Accueil','Rosson','044623245478','Responsable'),
('E','CH','OCHSNER Sport Neuchatel','10 Rue de la pierre à Mazel',2000,'Neuchâtel','Suisse','0336237250','ochsnerneu@gmail.cf','Veermer','0336237251','Accueil','Keerl','0336237252','Responsable ventes'),
('E','CH','OCHSNER Sport Bull','4 rue de l''europe',1630,'Bulle','Suisse','0337237250','ochsnerbulle@gmail.cf','Riddeough','0337237251','Acheteur','Fitz','0337237251','Commercial'),
('E','CH','OCHSNER Sport Luzern','50 Hertensteinstrasse',6004,'Luzerun','Suisse','0338237250','ochsnerluzern@gmail.cf','Maclan','0338237251','Commercial','Saudra','0338237252','Responsable ventes'),
('E','CH','OCHSNER Sport Stans','88 Stansstaderstrasse',6370,'Stans','Suisse','0334237250','ochsnerstans@gmail.cf','Paolino','0334237251','Accueil','Odde','0334237252','Commercial'),
('E','AT','SPORT 2000 Natter Talstation Bergbahnen','Hinterbündt 380',6881,'Mellau','Autriche','43535666603','sportnatter@gmail.cf','Emeney','43535666604','Accueil',null, null, null),
('E','AT','Olympiaplatz 2 EKZ Stadion Center','Hinterbündt 380',1020,'Wien','Autriche','43635666603','olym@gmail.cf','Keymer','43635666604','Accueil','Dutteridge','43635666605','Vendeur'),
('E','AT','SPORT 2000 Bich','Bichlstraße 7',6370,'Kitzbühel','Autriche','43735666606','sportbich@gmail.cf','Heady','43735666605','Commercial','Piddletown','43735666603','Vendeur'),
('E','IT','Foot Locker Rome','Via Tuscolana 855',00174,'Rome','Italie','390676985609','footlockerrome@gmail.cf','Heady','390676985610','Commercial','Piddletown','390676985608','Vendeur'),
('E','IT','Foot Locker Firenze','Borgo S. Lorenzo, 19/R',50123,'Firenze FI','Italie','390776985609','footlockerfirenze@gmail.cf','Heady','390776985610','Accueil','Piddletown','390776985608','Vendeur'),
('E','IT','The North Face Pavia','Corso Str. Nuova, 24',27100,'Pavia','Italie','390876985609','footlockerpavia@gmail.cf','Heady','390876985610','Commercial',null, null, null),
('E','IT','The North Face Reggio','Corso Giuseppe Garibaldi 11',42121,'Reggio Emilia RE','Italie','390576985609','footlockerrome@gmail.cf','Heady','390576985610','Accueil',null, null, null),
('E','GB','Nike Town','236 Oxford St',11345,'Londres','Royaume-Uni','442076604453','nikelondon@gmail.cf','Kirkwood','442076604454','Acheteur','Benny','442076604455','Vendeur'),
('E','GB','Lillywhites','24-36 Regent St',42121,'Londres','Royaume-Uni','442076604453','Lilly@gmail.cf','Forbes','442176604454','Accueil','Easum','442176604455','Acheteur');
...
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (1,Current_date-50,0,32600,39120);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (2,Current_date-50,0,5835,7002);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (3,Current_date-50,0,17054,20464.8);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (4,Current_date-50,0,10376,12451.2);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (5,Current_date-50,0,6970,8364);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (8,Current_date-50,0,3000,3600);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (9,Current_date-50,0,6450,7740);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (12,Current_date-50,200,19985,19985);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (13,Current_date-50,200,11840,11940);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (16,Current_date-50,200,11840,11940);
Insert into COMMANDE(NUMCLIENT,DATECOMMANDE,MONTANTFRAIS,MONTANTHT,MONTANTTTC) VALUES (17,Current_date-50,200,22887.5,22887.5);
